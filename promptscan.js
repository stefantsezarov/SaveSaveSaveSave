...
// WHO OWNS A DOMAIN
//
// Almost every check below turns on one question: where does the public
// suffix end and the registered name begin? Get it wrong and the tool
// accuses real websites. It already did once — with a last-two-labels
// rule, the owner of coinbase.co.uk reads as "co.uk", and an ordinary
// legitimate link earned a HIGH brand-impersonation finding.
//
// THE TABLE BELOW IS A DATED SUBSET OF THE PUBLIC SUFFIX LIST, NOT THE
// LIST. The real list runs to roughly fifteen thousand entries and
// changes every few weeks. Embedding a frozen copy of all of it in a
// page that must stay small would be a stale dependency presented as
// authoritative. build-suffixes.js regenerates this block from the
// upstream list; the provenance line says when it was last done and by
// what method.
//
//   SOURCE: curated from the ICANN section of the Public Suffix List
//   METHOD: hand-maintained subset; run `node build-suffixes.js` to
//           replace it with a generated snapshot of the upstream list
//   UPDATED: 2026-09-19
//
// Because it is a subset, a boundary it cannot resolve is treated as
// UNKNOWN rather than guessed — see domainParts() below. That is the
// part that actually keeps the false accusation from coming back: no
// brand judgement is ever made on a boundary we are not sure of.
//
// Hosting suffixes (github.io and similar) are deliberately EXCLUDED.
// On those the label really is registered by whoever asked for it, so a
// wallet brand sitting on one is worth flagging rather than excusing.
// >>> PUBLIC-SUFFIX-TABLE >>>
const MULTI_LABEL_SUFFIXES = new Set([
  'co.uk','org.uk','ac.uk','gov.uk','me.uk','net.uk','sch.uk','ltd.uk','plc.uk','nhs.uk','police.uk','mod.uk',
  'com.au','net.au','org.au','edu.au','gov.au','id.au','asn.au','csiro.au',
  'co.nz','net.nz','org.nz','govt.nz','ac.nz','geek.nz','school.nz','iwi.nz','maori.nz','health.nz',
  'co.jp','ne.jp','or.jp','ac.jp','go.jp','lg.jp','ad.jp','ed.jp','gr.jp',
  'co.kr','or.kr','ne.kr','go.kr','re.kr','pe.kr','seoul.kr','busan.kr',
  ...
  'com.br','net.br','org.br','gov.br','edu.br','art.br','eco.br','ind.br','blog.br','adv.br',
  'com.mx','org.mx','net.mx','edu.mx','gob.mx',
  'com.ar','net.ar','org.ar','gob.ar','edu.ar','int.ar','tur.ar',
  ...
  'co.cr','ac.cr','fi.cr','go.cr','or.cr','sa.cr',
  'com.cu','net.cu','org.cu','edu.cu','gov.cu',
  'com.tr','net.tr','org.tr','gov.tr','edu.tr','bel.tr','pol.tr','k12.tr','av.tr','web.tr',
  'co.za','org.za','net.za','gov.za','ac.za','web.za','edu.za',
  'co.in','net.in','org.in','gen.in','firm.in','gov.in','ac.in','edu.in','res.in','ind.in','mil.in','nic.in',
  'com.my','net.my','org.my','gov.my','edu.my','mil.my','name.my',
  'co.id','or.id','ac.id','go.id','web.id','net.id','sch.id','my.id','biz.id','desa.id',
  'com.ph','net.ph','org.ph','edu.ph','gov.ph','mil.ph','ngo.ph',
  'com.vn','net.vn','org.vn','edu.vn','gov.vn','ac.vn','biz.vn','info.vn','name.vn','pro.vn','health.vn',
  'co.il','org.il','net.il','ac.il','gov.il','k12.il','muni.il','idf.il',
  'co.th','in.th','ac.th','go.th','mi.th','net.th','or.th',
  'com.ua','net.ua','org.ua','gov.ua','edu.ua','in.ua','kiev.ua','kyiv.ua',
  'com.pl','net.pl','org.pl','gov.pl','edu.pl','info.pl','biz.pl','waw.pl','krakow.pl','gda.pl','wroc.pl',
  'co.at','or.at','ac.at','gv.at','biz.at','priv.at',
  'com.es','org.es','nom.es','gob.es','edu.es',
  'com.pt','org.pt','edu.pt','gov.pt','int.pt','nome.pt','publ.pt',
  'com.gr','net.gr','org.gr','edu.gr','gov.gr',
  'com.ru','net.ru','org.ru','edu.ru','gov.ru','int.ru','pp.ru','msk.ru','spb.ru',
  'com.by','net.by','org.by','gov.by',
  'com.kz','net.kz','org.kz','edu.kz','gov.kz',
  'com.ge','net.ge','org.ge','edu.ge','gov.ge','pvt.ge',
  ...
  'com.lk','net.lk','org.lk','edu.lk','gov.lk','ac.lk','sch.lk','web.lk',
  ...
  'com.om','net.om','org.om','edu.om','gov.om','med.om','pro.om',
  'com.jo','net.jo','org.jo','edu.jo','gov.jo','mil.jo','sch.jo',
  'com.lb','net.lb','org.lb','edu.lb','gov.lb',
  'com.ae','net.ae','org.ae','ac.ae','gov.ae','sch.ae','mil.ae',
  'co.ke','or.ke','ne.ke','go.ke','ac.ke','sc.ke','me.ke','info.ke',
  'co.tz','or.tz','ne.tz','go.tz','ac.tz','sc.tz','hotel.tz','mil.tz',
  'co.ug','or.ug','ne.ug','go.ug','ac.ug','sc.ug',
  'co.zw','org.zw','ac.zw','gov.zw',
  'co.zm','org.zm','ac.zm','gov.zm','sch.zm',
  'co.mz','org.mz','ac.mz','gov.mz','edu.mz',
  'co.ma','net.ma','org.ma','ac.ma','gov.ma','press.ma',
  'com.tn','net.tn','org.tn','edu.tn','gov.tn','ens.tn','fin.tn',
  'com.dz','net.dz','org.dz','edu.dz','gov.dz','asso.dz','pol.dz',
  'com.ly','net.ly','org.ly','edu.ly','gov.ly','med.ly','sch.ly',
  'com.et','net.et','org.et','edu.et','gov.et','biz.et','name.et',
  'com.bn','net.bn','org.bn','edu.bn','gov.bn',
  'com.kh','net.kh','org.kh','edu.kh','gov.kh','per.kh',
  'com.mm','net.mm','org.mm','edu.mm','gov.mm',
  'com.mt','net.mt','org.mt','edu.mt','gov.mt',
  'com.cy','net.cy','org.cy','ac.cy','gov.cy','biz.cy','press.cy',
  'com.hr','from.hr','iz.hr','name.hr',
  'com.ee','pri.ee','fie.ee','med.ee','aip.ee','org.ee',
  'com.lv','net.lv','org.lv','edu.lv','gov.lv','asn.lv','conf.lv','id.lv',
  'com.mk','net.mk','org.mk','edu.mk','gov.mk','inf.mk','name.mk',
  'com.ro','org.ro','store.ro','tm.ro','info.ro','nom.ro','nt.ro','www.ro',
  'com.bg','net.bg','org.bg','edu.bg',
  'com.rs','org.rs','edu.rs','in.rs','ac.rs','gov.rs',
  'com.ba','net.ba','org.ba','edu.ba','gov.ba','unsa.ba',
  'com.al','net.al','org.al','edu.al','gov.al',
  'co.me','net.me','org.me','ac.me','edu.me','gov.me','its.me','priv.me',
  'com.ki','com.fj','com.pg','com.sb','com.vu','com.to','com.ws','com.nf',
  'co.mu','com.mu','org.mu','ac.mu','gov.mu',
  'co.ao','it.ao','ed.ao','gv.ao','og.ao','pb.ao',
  'co.bw','org.bw','ac.bw','gov.bw',
  'com.na','co.na','org.na','alt.na',
  'com.ni','com.gi','com.gl','com.im','co.im','net.im','org.im','ac.im',
  'co.je','net.je','org.je','co.gg','net.gg','org.gg',
  'co.hu','film.hu','info.hu','org.hu','priv.hu','sport.hu','tm.hu',
]);
// <<< PUBLIC-SUFFIX-TABLE <<<

// Split a host into the registered name and the label that identifies
// its owner, and say whether we are SURE of the boundary.
//
// The third return value is the important one. When the suffix is not in
// our table and the host has the shape of a country-code registry we do
// not carry — a two-letter country code with a short administrative
// label before it, like the real "msk.ru" or "nom.za" — the boundary is
// reported as uncertain, and every brand judgement downstream is
// withheld. A missed detection on an unusual suffix is a smaller failure
// than telling somebody their bank's real website is impersonating their
// bank.
function domainParts(host) {
  const parts = String(host).toLowerCase().split('.').filter(Boolean);
  if (parts.length <= 2) {
    return { domain: parts.join('.'), label: parts[0] || '', certain: true };
  }
  if (MULTI_LABEL_SUFFIXES.has(parts.slice(-2).join('.'))) {
    return { domain: parts.slice(-3).join('.'), label: parts[parts.length - 3], certain: true };
  }
  const tld = parts[parts.length - 1];
  const sld = parts[parts.length - 2];
  const couldBeSuffix = tld.length === 2 && sld.length <= 3 && /^[a-z]+$/.test(sld);
  return { domain: parts.slice(-2).join('.'), label: sld, certain: !couldBeSuffix };
}

function registrable(host) { return domainParts(host).domain; }
function ownerLabel(host) { return domainParts(host).label; }
function suffixCertain(host) { return domainParts(host).certain; }
...
// Verbs that ask the reader to hand something over. Gerunds included:
// "by entering your…" is a request wearing a participle.
const SOLICIT_VERBS =
  'enter|entering|paste|pasting|type|typing|provide|providing|share|sharing|'
  + 'send|sending|submit|submitting|confirm|confirming|verify|verifying|'
  + 'validate|validating|input|inputting|supply|supplying|restore|restoring|'
  + 're-?enter|re-?entering|reveal|revealing|disclose|disclosing';

const SOLICIT_RE = new RegExp('\\b(?:' + SOLICIT_VERBS + ')\\s+(?:your|the)\\b|\\bbelow\\s*[:.]?\\s*$', 'i');

const WALLET_SECRET =
  'seed\\s?(?:phrase|words?)|recovery\\s?(?:phrase|words?|seed)|secret\\s+words?|'
  + 'backup\\s+phrase|mnemonic(?:\\s+phrase)?|private\\s?key|secret\\s?key|'
  + 'signing\\s?key|wallet\\s+password|keystore\\s+file|12[-\\s]word|24[-\\s]word';

// verb … your … secret. The gap allows the padding real phishing uses
// ("confirm ownership by entering your 12-word recovery phrase") and is
// bounded so it cannot cross a sentence boundary.
//
// NEWLINES ARE ALLOWED IN THE GAP, and that is not a detail. The first
// version excluded them, and guide 4's own example still scored LOW —
// because the message wraps between "your" and "12-word recovery phrase",
// exactly as a real email would. Every mail client on earth hard-wraps at
// around 72 characters. A detector that only works on unwrapped text does
// not work on messages.
const SECRET_SOLICIT_RE = new RegExp(
  '\\b(?:' + SOLICIT_VERBS + ')\\b[^.!?]{0,44}\\byour\\b[^.!?]{0,34}\\b(?:' + WALLET_SECRET + ')\\b',
  'i');
...
function directiveScore(fragment) {
  ...
  const solicits = SOLICIT_RE.test(f);
  // A second-person request for a WALLET SECRET, specifically. This is its
  // own signal because the phishing that matters almost never leads with a
  // bare imperative — it leads with a reason. Guide 4's own example said
  // "please confirm ownership by entering your 12-word recovery phrase"
  // and the CRITICAL seed-phrase rule was demoted to LOW, because a
  // subordinate clause and a gerund defeated the imperative test.
  //
  // Weighted at 0.6 so it clears the threshold alone: there is no innocent
  // second-person phrasing of "give me your recovery phrase". Advisory
  // negation still cancels it — "never enter your seed phrase anywhere" is
  // caught by ADVISORY_NEGATION before severity is decided — and third-
  // person description ("attackers ask for their seed phrase") does not
  // match this at all.
  const solicitsSecret = SECRET_SOLICIT_RE.test(f);
  const score = (addressesAssistant ? 0.5 : 0) + (bareImperative ? 0.5 : 0)
    + (solicitsSecret ? 0.6 : 0) + (solicits ? 0.3 : 0) - (referential ? 0.6 : 0);
  return { isDirective: score > 0.3, score, referential, addressesAssistant, bareImperative, solicits, solicitsSecret };
}
...
const RULES = [
  {
    ...
    // Two shapes. The first is the classic one: a cancelling verb followed by
    // a word for "what you were told". The second exists because guide 3's own
    // example said "disregard the summary request above" and scored nothing —
    // a single adjective between the article and the noun was enough to slip
    // past. Arbitrary filler is therefore allowed, but only when a positional
    // word ("above", "earlier") ties the sentence to something that came
    // before it, which is what makes it an override rather than an ordinary
    // "ignore the formatting notes".
    re: /\b(?:ignore|disregard|forget|discard)\s+(?:all\s+|any\s+|the\s+|your\s+|my\s+|that\s+|previous\s+|prior\s+|earlier\s+|above\s+|preceding\s+|[a-z]+['’]s\s+){0,3}(?:instructions?|prompts?|rules?|directives?|guidelines?|messages?|requests?|tasks?|context)\b|\b(?:ignore|disregard|forget|discard)\s+(?:all\s+|any\s+|the\s+|your\s+|my\s+|that\s+){0,2}(?:[a-z]+\s+){1,2}(?:instructions?|prompts?|rules?|directives?|guidelines?|messages?|requests?|tasks?)\s+(?:above|below|earlier|before|preceding)\b/i,
  ...
  {
    // The signature of an injection is not a magic phrase, it is a change
    // of addressee. Pasted material is supposed to be the thing the
    // assistant works ON. When part of it starts talking TO the assistant,
    // somebody has written two audiences into one message on purpose.
    id: 'PROMPT_ADDRESSED_001', category: 'PROMPT_INJECTION', severity: 'HIGH', confidence: 0.85,
    // The addressee has to end the phrase. "Note for the AI:" addresses the
    // AI; "a note for the AI newsletter" is about a newsletter and "a note to
    // the assistant team" is about people. Requiring a colon, dash or line
    // break after the addressee separates the two at no cost — a header
    // written for a machine to obey is punctuated that way already.
    re: /\b(?:note|notes|message|instruction|instructions|attention|reminder|memo)\s+(?:for|to)\s+(?:the\s+|any\s+)?(?:ai|a\.i\.|assistant|llm|model|chatbot|bot|language\s+model|system)\s*(?=[:\-–—]|\r?\n|$)|\bdear\s+(?:ai|assistant|chatgpt|claude|gemini|copilot|llm|language\s+model)\b|\b(?:ai|assistant|llm|chatbot)\s*[:,]\s*(?:ignore|disregard|instead|do\s+not|don'?t|please\s+(?:ignore|disregard))\b/i,
    title: 'Part of this text is addressed to the AI, not to you',
    plain: 'Somewhere in this message, the writing stops speaking to a reader and starts speaking to an AI system. Material you paste is meant to be what the assistant works on — there is no honest reason for it to contain instructions aimed at the assistant itself.',
    action: 'Do not paste this as-is. If you need the legitimate part of it, retype only that part yourself.',
    requiresDirective: true,
  },
  {
  ...
  {
    id: 'TOOL_ABUSE_002', category: 'DATA_EXFILTRATION', severity: 'MEDIUM', confidence: 0.7,
    re: /\b(?:list|enumerate|output|print|reveal|show|dump|repeat|share|disclose)\b[^.!?\n]{0,40}\b(?:everything|all|information|contents?|details|data|files?|messages?)\b[^.!?\n]{0,60}\b(?:you\s+(?:have\s+)?(?:access\s+to|can\s+(?:see|read|access))|(?:in|from)\s+(?:this|the)\s+(?:conversation|context|chat|thread))\b/i,
    title: 'Asks the AI to list everything it can reach',
    plain: 'The text asks the system to enumerate what it has access to and put the result somewhere. On its own that can be an innocent question about capabilities; inside a message someone else wrote, it is the first half of taking a copy.',
    action: 'Do not run this against an assistant that can see your files, messages or accounts.',
    requiresDirective: true,
  },
  {
...
// The wallet and exchange names this scanner exists to protect. Kept
// separate from BRANDS because the affix check below is too aggressive
// for the general-technology names: google-analytics.com, googleapis.com
// and paypalobjects.com are all real, and flagging them would be exactly
// the kind of false alarm that teaches people to ignore the tool.
const CRYPTO_BRANDS = ['metamask','coinbase','binance','ledger','trezor','phantom','uniswap','opensea','kraken','etherscan','trustwallet','exodus','pancakeswap','solflare'];

// Verified legitimate owner labels that would otherwise trip the affix
// check. DO NOT ADD A DOMAIN HERE WITHOUT CONFIRMING IT IS REALLY THE
// BRAND'S — an unverified entry here is a hole that silently excuses the
// exact domain an attacker wants excused. Empty is the honest default.
const BRAND_LABEL_ALLOW = new Set([]);

// Substitutions used to make one name read as another. Every entry is a
// trick seen in real campaigns, not every pair a font could confuse: a
// long confusables table produces matches nobody can explain, and an
// unexplainable HIGH finding is worse than no finding.
//
// WHY THIS BRANCHES INSTEAD OF NORMALISING. A single canonical spelling
// cannot work, because the same character imitates more than one letter:
// the digit 1 stands for l in "paypa1" and for i in "b1nance". Collapsing
// 1 to l catches the first and silently misses the second. So each
// ambiguous position produces alternatives and the whole set is tested.
const CONFUSABLE_SEQ = [[/rn/g, 'm'], [/vv/g, 'w'], [/nn/g, 'm'], [/cl/g, 'd']];
const CONFUSABLE_ALT = {
  '0': ['o'], '1': ['l', 'i'], '3': ['e'], '4': ['a'], '5': ['s'],
  '7': ['t'], '8': ['b'], '|': ['l', 'i'], '!': ['i', 'l'],
  'l': ['i'], 'i': ['l'],
};
const MAX_SEQ_FORMS = 8;
const MAX_CHAR_FORMS = 128;

// Every way this label could be read by someone glancing at it.
// Bounded on purpose: this runs in the visitor's browser, once per URL.
function deconfusions(label) {
  const base = String(label).toLowerCase();

  // Sequence swaps are OPTIONAL, not mandatory — a label that genuinely
  // contains "rn" must still be tested as itself.
  let forms = new Set([base]);
  for (const [re, to] of CONFUSABLE_SEQ) {
    for (const s of [...forms]) {
      const r = s.replace(re, to);
      if (r !== s) forms.add(r);
    }
    if (forms.size >= MAX_SEQ_FORMS) break;
  }
  ...
  for (const form of forms) {
    ...
    for (const ch of form) {
      const alts = CONFUSABLE_ALT[ch];
      if (!alts) { variants = variants.map(v => v + ch); continue; }
      const grown = [];
      for (const v of variants) { grown.push(v + ch); for (const a of alts) grown.push(v + a); }
      variants = grown.length > MAX_CHAR_FORMS ? grown.slice(0, MAX_CHAR_FORMS) : grown;
      if (variants.length >= MAX_CHAR_FORMS) break;
    }
...
function analyseUrls(text) {
  ...
  while ((m = re.exec(text)) !== null && urls.length < LIMITS.MAX_URLS) {
    ...
    info.suffixCertain = parts.certain;

    // EVERY BRAND JUDGEMENT BELOW DEPENDS ON KNOWING WHERE THE PUBLIC
    // SUFFIX ENDS. When we do not know, we say nothing about brands
    // rather than guessing — a missed detection on an unusual country
    // suffix is a far smaller failure than telling somebody that their
    // bank's real website is impersonating their bank.
    info.brandMisplaced = null;
    info.lookalike = null;
    info.brandAffix = null;
    info.boundaryUnknown = false;

    if (!parts.certain) {
      info.boundaryUnknown = BRANDS.some(b => host.includes(b));
    } else {
      // A known brand appearing anywhere except at the registrable domain.
      info.brandMisplaced = BRANDS.find(b =>
        (host.includes(b) && !parts.domain.startsWith(b)) ||
        (u.pathname.toLowerCase().includes(b) && !parts.domain.includes(b))
      ) || null;

      // 1. Deliberate character substitution: metarnask, paypa1, b1nance.
      //    The label is not a brand, but reading it the way an eye reads
      //    it makes it one. Nobody registers the collision by accident.
      if (!BRANDS.includes(label)) {
        for (const cand of deconfusions(label)) {
          if (cand !== label && BRANDS.includes(cand)) { info.lookalike = cand; break; }
        }
      }

      // 2. Brand plus extra words: metamask-wallet, secure-metamask,
      //    metamask1. The brand IS at the front of the registrable
      //    domain, so the misplacement check above says nothing at all.
      if (!info.lookalike && !BRAND_LABEL_ALLOW.has(label)) {
        const hit = CRYPTO_BRANDS.find(b => label !== b && label.replace(/[-_]/g, '').includes(b));
        if (hit) info.brandAffix = hit;
      }
    }
  ...
  for (const u of urls) {
    ...
    if (u.lookalike) {
      findings.push(makeFinding({
        ruleId: 'URL_LOOKALIKE_001', category: 'BRAND_IMPERSONATION', severity: 'HIGH', confidence: 0.9,
        title: `A link uses a near-copy of the name "${u.lookalike}"`,
        plain: `The owner of this address is "${u.ownerLabel}", which is not "${u.lookalike}" — it is spelled to be misread as it. Characters like rn for m, or the digit 1 for the letter l, look identical at normal size.`,
        technical: `Owner label "${u.ownerLabel}" normalises to "${u.lookalike}" under the confusable map, at offset ${u.offset}.`,
        evidence: { excerpt: clampExcerpt(text, u.offset, u.offset + u.raw.length), start: u.offset, end: u.offset + u.raw.length, fromNormalized: false },
        action: `Do not open this. Reach ${u.lookalike} by typing its address yourself or using a bookmark you made earlier.`, source: 'url',
      }));
    }
    if (u.brandAffix) {
      findings.push(makeFinding({
        ruleId: 'URL_BRAND_AFFIX_001', category: 'BRAND_IMPERSONATION', severity: 'MEDIUM', confidence: 0.7,
        title: `A link uses the name "${u.brandAffix}" with other words attached`,
        plain: `The owner of this address is "${u.ownerLabel}", not "${u.brandAffix}". Anyone may register a domain that contains a brand name — a real company's own site is almost always the bare name and nothing else.`,
        technical: `Owner label "${u.ownerLabel}" contains crypto brand "${u.brandAffix}" but is not equal to it, at offset ${u.offset}.`,
        evidence: { excerpt: clampExcerpt(text, u.offset, u.offset + u.raw.length), start: u.offset, end: u.offset + u.raw.length, fromNormalized: false },
        action: `Confirm the exact address on ${u.brandAffix}'s official channel before opening it. This can be a genuine sub-brand domain, and we cannot tell the difference from the text alone.`, source: 'url',
      }));
    }
    if (u.boundaryUnknown) {
      findings.push(makeFinding({
        ruleId: 'URL_SUFFIX_UNKNOWN_001', category: 'SUSPICIOUS_URL', severity: 'LOW', confidence: 0.5,
        title: 'A familiar name appears in an address we cannot fully resolve',
        plain: `This address ends in a suffix our list does not cover, so we cannot say for certain which part of "${u.host}" identifies its owner. We are not calling it an impersonation, because we would be guessing. Check the exact domain against one you already trust.`,
        technical: `Public-suffix boundary for ${u.host} is unresolved by the shipped suffix table; brand checks withheld. Offset ${u.offset}.`,
        evidence: { excerpt: clampExcerpt(text, u.offset, u.offset + u.raw.length), start: u.offset, end: u.offset + u.raw.length, fromNormalized: false },
        action: 'Open the service through a bookmark or an address you typed yourself rather than through this link.', source: 'url',
      }));
    }
